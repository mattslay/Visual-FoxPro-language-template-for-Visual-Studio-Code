...
define(["require", "exports"], function (require, exports) {
    exports.language = {
        ...
        keywords: [
				...
				'dtor','dtos','dtot','each','echo','edit','edit','editsource','ejec','eject','empt','empty','encrypt','end','endc','endcase','endde','enddefine','enddo','endfo','endfor','endfu','endfunc','endi','endp','endpri','endprintjob','endproc',
